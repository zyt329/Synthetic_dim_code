...
L = 12; Q = 16
J1 = range(0.70, 0.82, length = 7);sweeps = 10^7;Temp = range(0.56, 1.0, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_J100_012_sweep10e7"
