...
L = 16; Q = 16
J1 = [0.0];sweeps = 4*10^6;critical_region1 = [0.55, 0.7];critical_region2 = [0.55,0.7]
Temp = cat(range(0.01, critical_region1[1]-0.01, length = 20),#beginning part
...
=#
range(critical_region1[2]+0.01, 1, length = 20),#last part
