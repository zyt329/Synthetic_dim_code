...
L = 12; Q = 16
J1 = [0.0];sweeps = 4*10^7;#critical_region1 = [0.2, 0.4];critical_region2 = [0.55,0.7]
Temp=range(0.60,0.64,length=25)
...
content = "newM_nonperiodic_M2added_fine_peak_J1$(J1[1])_$(J1[end])_Q$(Q)_sweep$(sweeps)"
