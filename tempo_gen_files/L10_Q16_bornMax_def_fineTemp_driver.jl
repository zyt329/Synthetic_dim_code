...
save(
    "/nfs/home/zyt329/Research/Synthetic_dim_code/Remote_result/Metropolis_Max_def_fineTemp_L_$(L)__Q_$(Q)__sweeps_10e6_Date_$(Dates.format(my_time, "e_dd_u_yyyy_HH_MM_SS")).jld",
    "sim",
    sim,
)
println("L=$L, Q=$Q, Max_def_fineTemp finished at $(Dates.format(my_time, "e_dd_u_yyyy_HH_MM_SS"))")
