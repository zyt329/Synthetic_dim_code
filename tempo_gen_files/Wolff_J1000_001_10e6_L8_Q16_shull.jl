...
L = 8; Q = 16
J1 = range(0.0, 0.1, length = 2);sweeps = 10^6;Temp = range(0.001, 1, length = 100)#Temp range determined by fcn in the driver, not here.
content = "Wolff_J1000_001_sweep10e6"
