...
L = 16; Q = 16
J1 = range(0.84, 1.08, length = 7);sweeps = 10^5;Temp = range(0.56, 1, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_J1084_108_sweep10e5"
