...
L = 8; Q = 16
J1 = range(0.60, 0.85, length = 6);sweeps = 10^6;Temp = range(0.01, 1.0, length = 50)#Temp range determined by fcn in the driver, not here.
content = "newM_periodic_J1$(J1[1])_$(J1[end])_Q$(Q)_sweep$(sweeps)"
@time sim = driver(L = L, Q = Q, J1 = J1, sweeps = sweeps, Temp = Temp)

my_time = Dates.now()
save_path = "/nfs/home/zyt329/Research/Synthetic_dim_code/Bcrossing_result_newM/"
#"E:/UC Davis/Research/Synthetic Dimensions/Synthetic_dim_code/Bcrossing_result_newM_periodic/"
