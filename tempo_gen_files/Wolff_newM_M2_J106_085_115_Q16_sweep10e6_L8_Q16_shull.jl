...
L = 8; Q = 16
J1 = (0.6,0.85,1.15);sweeps = 10^6;Temp = range(0.01, 1, length = 10)#Temp range determined by fcn in the driver, not here.
content = "Wolff_newM_M2_J106_085_115_Q16_sweep10e6"
