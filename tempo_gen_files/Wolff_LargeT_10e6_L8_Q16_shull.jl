...
L = 8; Q = 16
J1 = range(0.0, 1.08, length = 7);sweeps = 10^6;Temp = range(0.56, 10^9, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_LargeT_sweep10e6"
