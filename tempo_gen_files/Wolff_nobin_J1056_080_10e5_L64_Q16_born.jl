...
L = 64; Q = 16
J1 = range(0.56, 0.80, length = 7);sweeps = 10^5;Temp = range(0.56, 0.648, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_J1056_080_sweep10e5"
