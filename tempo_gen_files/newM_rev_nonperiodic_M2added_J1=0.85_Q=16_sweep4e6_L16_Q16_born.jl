...
L = 16; Q = 16
J1 = [0.85];sweeps = 4*10^6;critical_region1 = [0.1, 0.25];critical_region2 = [0.55,0.8]
Temp = cat(range(0.01, critical_region1[1]-0.01, length = 10),
range(critical_region1[1], critical_region1[2], length = 50),
...
content = "newM_nonperiodic_M2added_J1$(J1[1])_$(J1[end])_Q$(Q)_sweep$(sweeps)"
