...
L = 10; Q = 16
J1 = range(0.0, 0.24, length = 7);sweeps = 10^6;Temp = range(0.5, 0.7, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_J100_024_sweep10e6"
