...
L = 12; Q = 16
J1 = range(0.0, 0.25, length = 6);sweeps = 10^6;Temp = range(0.01, 1, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_newM_J1000_025_sweep10e6"
