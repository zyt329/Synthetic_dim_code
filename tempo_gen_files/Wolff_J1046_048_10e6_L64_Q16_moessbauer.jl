...
L = 64; Q = 16
J1 = range(0.46, 0.48, length = 3);sweeps = 10^6;Temp = range(0.5, 0.7, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_J1046_048_sweep10e6"
