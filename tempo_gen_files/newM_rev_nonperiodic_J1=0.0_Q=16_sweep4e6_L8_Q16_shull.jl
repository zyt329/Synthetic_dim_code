...
L = 8; Q = 16
J1 = [0.0];sweeps = 4*10^6;critical_region = [0.55, 0.7]
Temp = cat(range(0.01, critical_region[1]-0.01, length = 10),range(critical_region[1], critical_region[2], length = 50),range(critical_region[2]+0.01, 1, length = 10), dims=1)#Temp range determined by fcn in the driver, not here.
