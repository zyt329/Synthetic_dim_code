...
L = 16; Q = 16
J1 = range(0.0, 1.15, length = 6);sweeps = 10^6;Temp = range(0.01, 10, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_newM_widetemp_J1$(J1[1])_$(J1[end])_Q$(Q)_sweep$(sweeps)"
