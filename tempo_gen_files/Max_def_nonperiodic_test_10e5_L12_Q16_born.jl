...
"""
function driver(; L = 8, Q = 16, J1 = [range(0.0, 1.0, length = 5);0.4;0.45], sweeps = 10^6, Temp = range(0.3, 0.7, length = 50))
    Esim = []
    Csim = []
    Bsim = []
    simulation = []
...
L = 12; Q = 16
J1 = [range(0.0, 1.0, length = 5); 0.4; 0.45];sweeps = 10^5
content = "Max_def_nonperiodic_test"
