...
L = 32; Q = 16
J1 = range(0.28, 0.52, length = 7);sweeps = 10^5;Temp = range(0.56, 0.648, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_nobin_J1028_052_sweep10e5"
