...
L = 48; Q = 16
J1 = range(0.40, 0.42, length = 3);sweeps = 10^6;Temp = range(0.5, 0.7, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_J1040_042_sweep10e6"
