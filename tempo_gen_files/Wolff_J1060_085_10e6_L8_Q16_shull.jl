...
L = 8; Q = 16
J1 = range(0.60, 0.85, length = 6);sweeps = 10^6;Temp = range(0.01, 1, length = 50)#Temp range determined by fcn in the driver, not here.
content = "Wolff_newM_J1060_085_sweep10e6"
